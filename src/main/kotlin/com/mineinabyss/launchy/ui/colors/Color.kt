...
class LaunchyColors(val hue: Float = 0.02f) {
    ...
    val md_theme_dark_error = Color(0xFFF2B8B5).applyHue()
    val md_theme_dark_onError = Color(0xFF601410).applyHue()
    val md_theme_dark_errorContainer = Color(0xFF8C1D18).applyHue()
    val md_theme_dark_onErrorContainer = Color(0xFFF9DEDC).applyHue()
